...
-- --------------------------------------------------
-- Date Created: 05/09/2018 18:31:46
-- Generated from EDMX file: C:\Users\Diogo\IPLeiria\Microsoft 2.0 - Documentos\DA\ImoDA\ImoDA\GCC.edmx
-- --------------------------------------------------
...
CREATE TABLE [dbo].[ArrendamentoSet] (
    [IdArrendamento] nvarchar(max)  NOT NULL,
    ...
    [ClienteIdCliente1] nvarchar(max)  NOT NULL,
    [CasaArrendavel_IdCasa] nvarchar(max)  NULL
);
GO

-- Creating table 'CasaSet'
CREATE TABLE [dbo].[CasaSet] (
    [IdCasa] nvarchar(max)  NOT NULL,
...
-- Creating foreign key on [ClienteIdCliente1] in table 'ArrendamentoSet'
ALTER TABLE [dbo].[ArrendamentoSet]
...
-- Creating foreign key on [ClienteIdCliente1] in table 'CasaSet'
ALTER TABLE [dbo].[CasaSet]
